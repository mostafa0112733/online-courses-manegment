          ...
          <div class="card-body" style="background-color: #F9F7F7;">
            ...
            <table class="table">
              ...
              <tbody>
                ...
                $qry = "SELECT Persons.*
                FROM Persons 
                WHERE Persons.Organizations_admins_id = '$user_id' AND Persons.user_type = 'instructor'";
                ...
                ?>
                  <tr>
                    ...
                    <td class="fw-bold">
                      <a href="show_instrator.php?id=<?= $r['id'] ?>" style="background-color:#146C94;color:#F9F7F7;" class="btn btn-sm  rounded-pill ">
                        <i class="fa-solid fas fa-eye"> view</i>
                      </a>
                      <a href="edit_instractor.php?id=<?= $r['id'] ?>" style="background-color:#146C94;color:#F9F7F7;" class="btn btn-sm  rounded-pill ">
                        <i class="fa-solid fas fa-pen-fancy"></i> Edit
                      </a>
                      <a href="del_ins.php?id=<?= $r['id'] ?>"style="background-color:#146C94;color:#F9F7F7;" class="btn btn-sm  rounded-pill ">

...
<body style="background-color:#DBE2EF;">
    <div class="container-fluid">
        <div class="row justify-content-center mt-5 pt-5">
            <div class="col-4">
                <div class="card" style="background-color: #F9F7F7; border-radius: 25px">
                    <h1 class="text-center my-3">Schedule Meeting</h1>
                    <div class="card-body">
                        ...
                        if (isset($_POST['meeting_name']) && isset($_POST['schedule'])) {
                            ...
                            // Retrieve instructor ID from courses_instructors table
                            ...
                            $qry = "INSERT INTO `Meetings` (`course_id`, `Person_id`, `meeting_name`, `Schedule`)
                                    VALUES ($id, $instructor_id, '$meeting_name', '$schedule')";
        ...
        <a href="instractor_header.php"class="position-fixed mb-5  btn position-fixed" style="background-color:#146C94;color:#F9F7F7;">go back</a>
